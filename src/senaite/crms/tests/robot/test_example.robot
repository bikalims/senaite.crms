...
#
#  $ bin/test -s senaite.crms -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src senaite.crms.testing.SENAITE_CRMS_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/senaite/crms/tests/robot/test_example.robot
#
